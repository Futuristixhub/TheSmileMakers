...
import com.smilemakers.ui.dashBoard.appointmentFragment.addAppointment.AppointmentFormActivity
import com.smilemakers.ui.dashBoard.appointmentFragment.addAppointment.Event
import com.smilemakers.ui.dashBoard.appointmentFragment.addAppointment.SnoozeReminderActivity
import com.smilemakers.ui.dashBoard.appointmentFragment.calendar.EventTypesDao
import com.smilemakers.ui.dashBoard.appointmentFragment.calendar.EventsDao
import com.smilemakers.ui.dashBoard.appointmentFragment.calendar.EventsDatabase
...
fun Context.notifyEvent(originalEvent: Event) {
    ...
    val startTime = getTimeFromTS(applicationContext, event.startTS)
    val endTime = getTimeFromTS(applicationContext, event.endTS)
    val startDate = getDateFromTS(event.startTS)
