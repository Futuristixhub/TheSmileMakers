...
class IcsExporter {
    ...
    fun exportEvents(activity: SimpleActivity, file: File, events: ArrayList<Event>, showExportingToast: Boolean, callback: (result: ExportResult) -> Unit) {
        ...
        activity.getFileOutputStream(fileDirItem, true) {
            ...
            ensureBackgroundThread {
                ...
                callback(when {
                    eventsExported == 0 -> ExportResult.EXPORT_FAIL
                    eventsFailed > 0 -> ExportResult.EXPORT_PARTIAL
