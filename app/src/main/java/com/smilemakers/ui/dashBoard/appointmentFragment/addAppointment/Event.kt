...
import com.smilemakers.ui.dashBoard.appointmentFragment.calendar.getAllTimeZones
...
data class Event(
    ...
    fun getTimeZoneString(): String {
        return if (timeZone.isNotEmpty() && getAllTimeZones()
                .map { it.zoneName }.contains(timeZone)) {
            timeZone
        } else {
    ...
    override fun equals(obj: Any?): Boolean {
        ...
        val person: Event = obj as Event

        return person.startTS?.equals(startTS)!!
    }

//    override fun hashCode(): Int {
//        return startTS.toInt()
//    }
}
